...
setup(
    ...
    install_requires=['kivymd', 'pydash', 'treelib', 'kivyoav','wexpect', 'pexpect', 'qrcode', 'save_thread_result', 'screeninfo','stripe','pycoingecko', 'mapview', 'psutil', 'unidecode'],
    package_data={'conf': ['config/config.ini'], 'bin' : ['sentinelcli.exe', 'warp-cli','warp-svc', 'WireGuard'], 'awoc' : ['data/world.json'],
